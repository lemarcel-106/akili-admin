...
export default function CountriesPage() {
  ...
  const handleCreateCountry = async () => {
    ...
    try {
      const response = await dataAPI.createCountry(formData)
      if (response.data) {
        setSuccess('Pays créé avec succès')
      ...
      setError('Erreur lors de la création du pays')
    } finally {
  ...
  const handleEditCountry = async () => {
    if (!selectedCountry || !formData.name || !formData.iso_code) {
      setError('Tous les champs sont requis')
      return
    }
    ...
    try {
      const response = await dataAPI.updateCountry(selectedCountry.id, formData)
      if (response.data) {
      ...
      setError('Erreur lors de la modification du pays')
    } finally {
      setFormLoading(false)
    }
  }
  ...
  const handleDeleteCountry = async () => {
    ...
    try {
      const response = await dataAPI.deleteCountry(selectedCountry.id)
      ...
      setError('Erreur lors de la suppression du pays')
    } finally {
      setFormLoading(false)
    }
  }
  ...
  const filteredCountries = countries.filter(country => {
    ...
    return name.includes(q) || isoCode.includes(q)
  })
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 mt-1">
                  Gérez les pays disponibles sur la plateforme
                </p>
              </div>
            </div>
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-gray-50 dark:bg-gray-800/50">
                      ...
                      <TableHead className="font-bold">Code ISO</TableHead>
                        ...
                        filteredCountries.map((country, index) => (
                          ...
                          >
                            ...
                            <TableCell>
                              <Badge 
                                variant="outline"
                                className="font-mono font-semibold border-violet-200 text-violet-700 bg-violet-50 dark:border-violet-700 dark:text-violet-300 dark:bg-violet-900/30"
                              >
                                {country.iso_code}
                              </Badge>
                            </TableCell>
                            ...
                            <TableCell className="text-center">
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                  <DropdownMenuItem onClick={() => openDetailsModal(country)}>
          ...
          <DialogContent className="max-w-md">
            ...
            <div className="space-y-4 mt-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, iso_code: e.target.value.toUpperCase().slice(0, 2) }))}
                  placeholder="FR"
                  maxLength={2}
                  className="text-center font-mono"
                />
                <p className="text-xs text-gray-500">Code à 2 lettres (ISO 3166-1) - {formData.iso_code.length}/2</p>
              </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="is_active" className="font-normal">Pays actif</Label>
              </div>
            </div>
            ...
            <div className="flex gap-3 pt-4">
              ...
              <Button
                ...
                disabled={formLoading || !formData.name || !formData.iso_code}
        ...
        <Dialog open={showEditModal} onOpenChange={setShowEditModal}>
          <DialogContent className="max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Modifiez les informations du pays {selectedCountry?.name}.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4 mt-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="edit_iso_code">Code ISO *</Label>
                <Input
                  id="edit_iso_code"
                  value={formData.iso_code}
                  onChange={(e) => setFormData(prev => ({ ...prev, iso_code: e.target.value.toUpperCase().slice(0, 2) }))}
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="rounded border-gray-300"
                />
                <Label htmlFor="edit_is_active" className="font-normal">Pays actif</Label>
              </div>
            </div>
        ...
        <Dialog open={showDeleteModal} onOpenChange={setShowDeleteModal}>
          <DialogContent className="max-w-sm">
            <DialogHeader>
              ...
              <DialogDescription>
                Êtes-vous sûr de vouloir supprimer définitivement le pays <strong>{selectedCountry?.name}</strong> ? Cette action supprimera également tous les examens, séries et matières associées.
              </DialogDescription>
            </DialogHeader>
          ...
          <DialogContent className="max-w-lg">
            <DialogHeader>
              <DialogTitle className="flex items-center gap-2">
                ...
                Détails de {selectedCountry?.name}
              </DialogTitle>
            </DialogHeader>
            ...
            {selectedCountry && (
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label className="text-sm font-medium text-gray-500">Code ISO</Label>
                    <Badge className="mt-1 font-mono">{selectedCountry.iso_code}</Badge>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{selectedCountry.created_by || 'N/A'}</p>
                  </div>
                </div>
              </div>
            )}
